...
I have uploaded this project on heroku, here is the link " https://ankiwebmytodo.herokuapp.com "

"webproject2" is the main working project and "users" is the app that contains views.py file, all html files, all css files, etc. 
